module MailerHelper
  ...
  def mailer_spacing
    "margin: 0;padding: 0;line-height: 1.5em;margin-top: 12px;"
  end
  ...
  def css_for_mailer_org
    mailer_font_family + mailer_spacing + "color: #797f7f; font-size: 12px;"
  end

  def css_for_mailer_footer
    mailer_font_family + mailer_spacing + "color: #222; font-size: 10px;"
  end
